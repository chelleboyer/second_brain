...
CORPORATE_INFLUENCE = [
    InfluenceDelta(
        ...
        advice_sought=False, decision_changed=False, framing_adopted=False,
        consultation_count=1,
        stakeholder_name="Ryan Liu",
        notes="Quiet week. Had a brief chat with Ryan about embedding pipelines.",
    ),
    InfluenceDelta(
...
PERSONAL_INFLUENCE = [
    InfluenceDelta(
        ...
        notes="Holiday week. No real outreach. Drafted newsletter but didn't publish.",
    ),
    InfluenceDelta(
        week_start="2026-01-05",
        advice_sought=False, decision_changed=False, framing_adopted=False,
        ...
        notes="Restarted weekly check-ins with Casey. Low engagement week while ramping back up.",
    ),
    InfluenceDelta(
        week_start="2026-01-12",
        advice_sought=True, decision_changed=False, framing_adopted=False,
